...
export const submitContact = createAsyncThunk(
  ...
  async (contactData, { dispatch, rejectWithValue }) => {
    try {
      const response = await fetch(`${network.api}contact`, {
        method: 'POST',
        headers: {
...
export const fetchContacts = createAsyncThunk(
  ...
  async (_, { dispatch, rejectWithValue }) => {
    try {
      ...
      dispatch(
        createAlert({ type: 'error', message: 'Error fetching contacts' })
      );
...
export const fetchContact = createAsyncThunk(
  ...
  async (id, { dispatch, rejectWithValue }) => {
    try {
      ...
      dispatch(
        createAlert({ type: 'error', message: 'Error fetching contact' })
      );
      return rejectWithValue(error.response?.data);
    }
  }
...
export const updateContact = createAsyncThunk(
  ...
  async ({ id, data }, { dispatch, rejectWithValue }) => {
    try {
      ...
      dispatch(
        createAlert({ type: 'error', message: 'Error updating contact' })
      );
      return rejectWithValue(error.response?.data);
    }
  }
...
export const deleteContact = createAsyncThunk(
  ...
  async (id, { dispatch, rejectWithValue }) => {
    try {
      ...
      dispatch(
        createAlert({ type: 'error', message: 'Error deleting contact' })
      );
      return rejectWithValue(error.response?.data);
    }
  }
